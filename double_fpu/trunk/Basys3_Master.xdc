...
#set_property IOSTANDARD LVCMOS33 [get_ports {clk}]
set_property PACKAGE_PIN T1 [get_ports {ctrl[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ctrl[0]}]
set_property PACKAGE_PIN R2 [get_ports {ctrl[1]}]
...
set_property PACKAGE_PIN W18 [get_ports {Z}]
set_property IOSTANDARD LVCMOS33 [get_ports {Z}]
set_property PACKAGE_PIN U15 [get_ports {CF}]
...
#set_property PACKAGE_PIN L1 [get_ports {e_clock}]
#set_property IOSTANDARD LVCMOS33 [get_ports {e_clock}]
